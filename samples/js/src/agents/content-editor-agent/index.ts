...
async function main() {
  ...
  const PORT = process.env.CONTENT_EDITOR_AGENT_PORT || 41243;
  expressApp.listen(PORT, () => {
    console.log(`[ContentEditorAgent] Server using new framework started on http://localhost:${PORT}`);
    console.log(`[ContentEditorAgent] Agent Card: http://localhost:${PORT}/.well-known/agent.json`);
