...
//DEPS io.github.a2asdk:a2a-java-sdk-client-transport-spi:0.3.3.Final
 ...
 *
 * <ul>
 *   <li>Connect to an A2A agent using JSONRPC transport with OAuth2 authentication
 ...
 *   <li>A running Meeting Scheduler A2A server agent that supports the specified
 ...
 *   <li>Communicate with the Meeting Scheduler A2A server agent
...
public final class TestClientRunner {
  ...
  public static void main(final String[] args) {
    ...
    try {
      ...
      System.out.println("Using transport: jsonrpc");
      ...
      // Create the A2A client with JSONRPC transport using TestClient
      Client client = TestClient.createClient(publicAgentCard, messageResponse);

      // Create and send the message
      Message message = A2A.toUserMessage(messageText);

      System.out.println("Sending message: " + messageText);
      System.out.println("Using jsonrpc transport with OAuth2 Bearer token");
      try {
