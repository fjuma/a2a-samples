...
class CoordinatorAgent:
    ...
    This is the agent responsible for sending tasks to agents sequentially, using the output
    from the first agent to pass to the second agent.
    """
    ...
    def root_instruction(self, context: ReadonlyContext) -> str:
        ...
        return f"""
        **Role:** You are an expert coordinator that provides content given a high-level description of the content to be created.
        Your primary function is to coordinate the creation of content by sending requests to a content planning agent followed by a content writing agent.
        The content planning agent will provide an outline for the content to be written. Provide the outline created by the content planning agent to the
